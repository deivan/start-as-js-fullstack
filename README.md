...
Роутінг за допомогою контролерів Nest.js. Поєднання запитів до статичних сторінок та запитів до API. Вбудований у CLI генератор коду обробки роутів для контроллера. Популярні декоратори для обробки запитів - @Request(), @Response(), @Session(), @Param() ...
...
## 10. Поєднання побудованих моделей даних до сервісів та контролерів нашої аплікації, буде багато (2 пари)
...

### 11. Створення базової бізнес-логіки для нашої аплікації - кабінет користувача, налаштування, публічний профіль  (2 пари)
...

### 12. Створення функціоналу приватних повідомлень між користувачами та коментарів (1 пара)
...
