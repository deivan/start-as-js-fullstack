...
Завдяки суворій типізації, можливості описувати структуру об’єктів та використанню класів, TypeScript робить розробку у NestJS більш надійною, гнучкою та масштабованою.
...
const userDto: BaseDto<UserDto> = {
  data: { name: "Андрій", email: "max@example.com" }
};
```
