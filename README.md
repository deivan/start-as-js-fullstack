...
Два типи архітектури баз даних - SQL та noSQL. Інтерфейси підключення двигуну бази даних до бекенд аплікації. Використання зовнішнього схрону для бази даних аплікації, синхронізація та бекапи. Підключаємо до нашого бекенду базу MongoDB. Заводимо користувачів у базу.

## 08. Роутінг та створення REST API (1 пара)
